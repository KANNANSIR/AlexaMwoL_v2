...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By KriZ SeR' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919633687665@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    YAK: process.env.YAK === undefined ? '919633687665,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
